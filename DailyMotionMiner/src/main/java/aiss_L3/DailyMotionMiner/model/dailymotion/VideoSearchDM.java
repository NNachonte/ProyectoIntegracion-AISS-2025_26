...
public class VideoSearchDM {
    ...
    @JsonProperty("list")
    public List<VideoDM> getList() {
        return list;
    }

    @JsonProperty("list")
    public void setList(List<VideoDM> list) {
        this.list = list;
    }
    ...
    public String toString() {
        ...
        sb.append(VideoSearchDM.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("page");
        sb.append('=');
