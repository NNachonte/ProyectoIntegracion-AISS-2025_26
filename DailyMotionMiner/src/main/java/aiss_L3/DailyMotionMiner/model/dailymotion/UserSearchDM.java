...
public class UserSearchDM {
    ...
    @JsonProperty("list")
    public List<UserDM> getList() {
        return list;
    }

    @JsonProperty("list")
    public void setList(List<UserDM> list) {
        this.list = list;
    }
    ...
    public String toString() {
        ...
        sb.append(UserSearchDM.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("page");
        sb.append('=');
